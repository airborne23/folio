 ...
 *
 * Uses exact hostname match against `cdnDomain` (e.g. "folio-static.copilothub.ai"),
 ...
 * @param cdnDomain CDN hostname for legacy link detection (e.g. "folio-static.copilothub.ai")
 */
