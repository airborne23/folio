...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // Anthropic cream card: warm-beige 1px border (--border token)
        // replaces the previous ring-1/ink-10% blend so the boundary reads
        // warm against the cream canvas instead of looking like a cool
        // shadow stub. rounded-lg (8px) over the previous xl (~11px) makes
        // the corners feel letterpressed rather than soft-UI.
