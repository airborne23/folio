...
import { useCreateWorkspace } from "@folio/core/workspace/mutations";
import type { Workspace } from "@folio/core/types";
import { DragStrip } from "@folio/views/platform";
import { WorkspaceAvatar } from "../../workspace/workspace-avatar";

// Tiny radio-dot — option-card.tsx (the original home) was deleted when
// the multi-step onboarding flow collapsed to a single workspace step;
// keeping this 15-line helper local is cheaper than reviving the module.
 ...
 * rendered as a `folio.ai/[slug]` pill, and a live `Issues will look
