...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from "@folio/ui/components/ui/collapsible";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
...
import { useScrollFade } from "@folio/ui/hooks/use-scroll-fade";
import { useAutoScroll } from "@folio/ui/hooks/use-auto-scroll";
import { taskMessagesOptions } from "@folio/core/chat/queries";
import { Markdown } from "@folio/views/common/markdown";
import { copyMarkdown } from "../../editor";
import type { AgentAvailability } from "@folio/core/agents";
import type { ChatMessage, ChatPendingTask, TaskMessagePayload, TaskFailureReason } from "@folio/core/types";
import type { ChatTimelineItem } from "@folio/core/chat";
