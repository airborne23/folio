...
import type { Agent, AgentRuntime, CreateAgentRequest } from "@folio/core/types";
import {
...
import { canAssignAgentToIssue } from "@folio/core/permissions";
...
import { DataTable } from "@folio/ui/components/ui/data-table";
    ...
    <PageHeader className="justify-between px-5">
      <div className="flex items-center gap-2">
        ...
        <p className="ml-2 hidden text-xs text-muted-foreground md:block">
          {t(($) => $.page.tagline)}{" "}
          <a
            href="https://folio.ai/docs/agents"
            target="_blank"
