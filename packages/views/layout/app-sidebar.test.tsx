...
vi.mock("@folio/ui/components/ui/sidebar", () => ({
...
vi.mock("@folio/ui/components/ui/collapsible", () => ({
...
vi.mock("@folio/ui/components/common/actor-avatar", () => ({ ActorAvatar: () => <span /> }));
...
vi.mock("@folio/core/issues/stores/create-mode-store", () => ({ useCreateModeStore: { getState: () => ({ lastMode: "agent" }) } }));
vi.mock("@folio/core/issues/stores/draft-store", () => ({ useIssueDraftStore: () => false }));
