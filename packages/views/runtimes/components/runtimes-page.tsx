...
import { runtimeListOptions, runtimeKeys } from "@folio/core/runtimes/queries";
import { useUpdatableRuntimeIds } from "@folio/core/runtimes/hooks";
    ...
    <PageHeader className="justify-between px-5">
      <div className="flex items-center gap-2">
        ...
        <p className="ml-2 hidden text-xs text-muted-foreground md:block">
          {t(($) => $.page.tagline)}{" "}
          <a
            href="https://folio.ai/docs/runtimes"
            target="_blank"
