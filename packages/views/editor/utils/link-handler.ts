...
import { isGlobalPath } from "@folio/core/paths";
...
/**
 * Open a link — internal paths dispatch folio:navigate, external open new tab.
 *
...
export function openLink(href: string, currentSlug?: string | null): void {
  if (href.startsWith("/")) {
    ...
    window.dispatchEvent(
      new CustomEvent("folio:navigate", { detail: { path } }),
    );
  } else {
