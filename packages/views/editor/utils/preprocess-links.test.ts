...
import { preprocessLinks } from "@folio/ui/markdown/linkify";
...
describe("preprocessLinks — CJK punctuation boundary", () => {
  ...
  it("handles the original bug report (PR link then 。 then more text)", () => {
    const out = preprocessLinks(
      "已合并 PR #1623：https://github.com/airborne23/folio/pull/1623。merge commit",
    );
    expect(out).toBe(
      "已合并 PR #1623：[https://github.com/airborne23/folio/pull/1623](https://github.com/airborne23/folio/pull/1623)。merge commit",
    );
  });
