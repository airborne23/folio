...
import { DialogTitle } from "@folio/ui/components/ui/dialog";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
} from "@folio/core/runtimes";
import { useFileUpload } from "@folio/core/hooks/use-file-upload";
import { formatShortcut, modKey, enterKey } from "@folio/core/platform";
import type { Agent } from "@folio/core/types";
...
export function AgentCreatePanel({
  ...
  // bundled Folio CLI to be ≥ MIN_QUICK_CREATE_CLI_VERSION; older
