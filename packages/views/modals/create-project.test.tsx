...
const longRepoUrl =
  "https://github.com/airborne23/a-very-long-repository-name-that-needs-a-tooltip";

vi.mock("@tanstack/react-query", () => ({
  useQuery: () => ({ data: [] }),
}));

vi.mock("@folio/core/projects/mutations", () => ({
  useCreateProject: () => ({ mutateAsync: vi.fn() }),
}));

vi.mock("@folio/core/projects", () => ({
...
vi.mock("@folio/ui/components/ui/popover", () => ({
...
vi.mock("@folio/ui/components/common/emoji-picker", () => ({
  EmojiPicker: () => null,
}));
