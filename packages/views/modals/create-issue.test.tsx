...
vi.mock("@folio/core/issues/queries", () => ({
...
vi.mock("@folio/core/issues/stores/draft-store", () => ({
...
vi.mock("@folio/core/issues/stores/quick-create-store", () => ({
  useQuickCreateStore: (selector?: (state: typeof mockQuickCreateStore) => unknown) =>
    (selector ? selector(mockQuickCreateStore) : mockQuickCreateStore),
}));

vi.mock("@folio/core/issues/mutations", () => ({
...
vi.mock("@folio/ui/components/ui/dialog", () => ({
...
vi.mock("@folio/ui/components/ui/tooltip", () => ({
  Tooltip: ({ children }: { children: React.ReactNode }) => <>{children}</>,
  TooltipTrigger: ({ render }: { render: React.ReactNode }) => <>{render}</>,
  TooltipContent: ({ children }: { children: React.ReactNode }) => <>{children}</>,
}));

vi.mock("@folio/ui/components/ui/button", () => ({
  Button: ({
    children,
    disabled,
    onClick,
...
vi.mock("@folio/ui/components/ui/switch", () => ({
  Switch: ({
    checked,
    onCheckedChange,
  }: {
...
vi.mock("@folio/ui/components/common/file-upload-button", () => ({
