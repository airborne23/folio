...
import type { Issue, IssueStatus, IssuePriority, IssueAssigneeType } from "@folio/core/types";
import {
  DialogContent,
  DialogTitle,
...
import { Switch } from "@folio/ui/components/ui/switch";
...
import { useQuickCreateStore } from "@folio/core/issues/stores/quick-create-store";
import { issueDetailOptions } from "@folio/core/issues/queries";
import { useCreateIssue, useUpdateIssue } from "@folio/core/issues/mutations";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const shouldShowBacklogHint =
        ...
        localStorage.getItem("folio:backlog-agent-hint-dismissed") !== "true";
        ...
        {backlogHintIssueId ? (
          <BacklogAgentHintContent
            ...
            onDismissPermanently={() => {
              localStorage.setItem("folio:backlog-agent-hint-dismissed", "true");
            }}
            onMoveToTodo={() => {
...
import { Dialog as DialogRoot } from "@folio/ui/components/ui/dialog";
