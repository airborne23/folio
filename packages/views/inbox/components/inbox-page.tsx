...
} from "@folio/core/inbox/mutations";
...
import type { InboxItem } from "@folio/core/types";
import { Button } from "@folio/ui/components/ui/button";
import {
  ResizablePanelGroup,
  ResizablePanel,
  ResizableHandle,
} from "@folio/ui/components/ui/resizable";
...
export function InboxPage() {
  ...
  const listHeader = (
    <PageHeader className="justify-between">
      <div className="flex items-baseline gap-2">
        <h1 className="text-base font-medium tracking-tight">{t(($) => $.page.title)}</h1>
        {unreadCount > 0 && (
  ...
  const detailContent = selected?.issue_id ? (
    ...
    <IssueDetail
      ...
      layoutId="folio_inbox_issue_detail_layout"
