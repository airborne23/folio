...
import type { Issue, IssueStatus, ProjectStatus, ProjectPriority } from "@folio/core/types";
import { useAuthStore } from "@folio/core/auth";
import { projectDetailOptions } from "@folio/core/projects/queries";
import { useUpdateProject, useDeleteProject } from "@folio/core/projects/mutations";
import { pinListOptions } from "@folio/core/pins";
import { useCreatePin, useDeletePin } from "@folio/core/pins";
import { myIssueListOptions, childIssueProgressOptions, type MyIssuesFilter } from "@folio/core/issues/queries";
...
import { PROJECT_STATUS_ORDER, PROJECT_STATUS_CONFIG, PROJECT_PRIORITY_ORDER } from "@folio/core/projects/config";
import { BOARD_STATUSES } from "@folio/core/issues/config";
import { createIssueViewStore } from "@folio/core/issues/stores/view-store";
import { ViewStoreProvider, useViewStore } from "@folio/core/issues/stores/view-store-context";
...
import {
  ...
  PopoverTrigger,
  PopoverContent,
} from "@folio/ui/components/ui/popover";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
} from "@folio/ui/components/ui/tooltip";
import { EmojiPicker } from "@folio/ui/components/common/emoji-picker";
...
import {
  ...
  AlertDialogHeader,
  AlertDialogTitle,
} from "@folio/ui/components/ui/alert-dialog";
...
export function ProjectDetail({ projectId }: { projectId: string }) {
  ...
  const { defaultLayout, onLayoutChanged } = useDefaultLayout({
    id: "folio_project_detail_layout",
  });
