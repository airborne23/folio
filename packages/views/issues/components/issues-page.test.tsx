...
import type { Issue } from "@folio/core/types";
...
// Mock @folio/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
vi.mock("@folio/core/issues/stores/view-store", () => ({
...
vi.mock("@folio/core/issues/stores/view-store-context", () => ({
  ViewStoreProvider: ({ children }: { children: React.ReactNode }) => children,
  useViewStore: (selector?: any) => (selector ? selector(mockViewState) : mockViewState),
  useViewStoreApi: () => ({ getState: () => mockViewState, setState: vi.fn(), subscribe: vi.fn() }),
}));

vi.mock("@folio/core/issues/stores/issues-scope-store", () => ({
...
vi.mock("@folio/core/issues/stores/selection-store", () => ({
...
vi.mock("@folio/core/issues/stores/recent-issues-store", () => ({
