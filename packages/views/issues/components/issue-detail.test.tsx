...
import type { Issue, TimelineEntry } from "@folio/core/types";
...
vi.mock("@folio/ui/hooks/use-mobile", () => ({
  useIsMobile: () => mockViewport.isMobile,
}));

// useWorkspaceId() derives from useCurrentWorkspace (relative import inside
// @folio/core/hooks.tsx). vi.mock("@folio/core/paths") only intercepts
...
// Mock @folio/core/workspace/hooks
vi.mock("@folio/core/workspace/hooks", () => ({
  useActorName: () => ({
...
// Mock @folio/core/paths — after the URL-driven workspace refactor,
...
vi.mock("@folio/core/paths", async () => {
  const actual = await vi.importActual<typeof import("@folio/core/paths")>(
    "@folio/core/paths",
  );
  return {
    ...actual,
...
// Mock issue config
vi.mock("@folio/core/issues/config", () => ({
...
vi.mock("@folio/core/issues/stores", () => ({
...
// Mock react-resizable-panels (used by @folio/ui/components/ui/resizable)
