...
import { ResizablePanelGroup, ResizablePanel, ResizableHandle } from "@folio/ui/components/ui/resizable";
import { Sheet, SheetContent } from "@folio/ui/components/ui/sheet";
import { useIsMobile } from "@folio/ui/hooks/use-mobile";
import { ContentEditor, type ContentEditorRef, TitleEditor, useFileDropZone, FileDropOverlay } from "../../editor";
import { FileUploadButton } from "@folio/ui/components/common/file-upload-button";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
} from "@folio/ui/components/ui/tooltip";
import { Popover, PopoverTrigger, PopoverContent } from "@folio/ui/components/ui/popover";
import { Checkbox } from "@folio/ui/components/ui/checkbox";
import { Command, CommandInput, CommandList, CommandEmpty, CommandGroup, CommandItem } from "@folio/ui/components/ui/command";
import { AvatarGroup, AvatarGroupCount } from "@folio/ui/components/ui/avatar";
import { ActorAvatar } from "../../common/actor-avatar";
import { PropRow } from "../../common/prop-row";
import type { IssueStatus, IssuePriority, TimelineEntry } from "@folio/core/types";
import { STATUS_CONFIG, PRIORITY_CONFIG } from "@folio/core/issues/config";
...
import { useCurrentWorkspace, useWorkspacePaths } from "@folio/core/paths";
import { useActorName } from "@folio/core/workspace/hooks";
import { useWorkspaceId } from "@folio/core/hooks";
import { issueListOptions, issueDetailOptions, childIssuesOptions, issueUsageOptions } from "@folio/core/issues/queries";
import { memberListOptions, agentListOptions } from "@folio/core/workspace/queries";
import { useRecentIssuesStore } from "@folio/core/issues/stores";
import { useIssueTimeline } from "../hooks/use-issue-timeline";
import { useIssueReactions } from "../hooks/use-issue-reactions";
import { useIssueSubscribers } from "../hooks/use-issue-subscribers";
import { ReactionBar } from "@folio/ui/components/common/reaction-bar";
import { useFileUpload } from "@folio/core/hooks/use-file-upload";
import { api } from "@folio/core/api";
import { useModalStore } from "@folio/core/modals";
import { timeAgo } from "@folio/core/utils";
...
export function IssueDetail({ issueId, onDelete, onDone, defaultSidebarOpen = true, layoutId = "folio_issue_detail_layout", highlightCommentId }: IssueDetailProps) {
  const { t } = useT("issues");
  const id = issueId;
