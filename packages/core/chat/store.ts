...
const AGENT_STORAGE_KEY = "folio:chat:selectedAgentId";
const SESSION_STORAGE_KEY = "folio:chat:activeSessionId";
/** Drafts are stored as one JSON blob per workspace: { [sessionId]: text }. */
const DRAFTS_KEY = "folio:chat:drafts";
/** Placeholder sessionId for a chat that hasn't been created yet. */
export const DRAFT_NEW_SESSION = "__new__";
const CHAT_WIDTH_KEY = "folio:chat:width";
const CHAT_HEIGHT_KEY = "folio:chat:height";
const CHAT_EXPANDED_KEY = "folio:chat:expanded";
/** Focus mode is a personal preference — global across workspaces/sessions. */
const FOCUS_MODE_KEY = "folio:chat:focusMode";
/**
 ...
 */
const OPEN_KEY = "folio:chat:isOpen";
