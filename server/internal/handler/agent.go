...
type AgentTaskResponse struct {
	...
	ChannelID               string          `json:"channel_id,omitempty"`                // non-empty for channel-context tasks
	ChannelPrompt           string          `json:"channel_prompt,omitempty"`            // rendered conversation history prompt for channel tasks
}
