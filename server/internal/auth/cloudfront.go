...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.folio.ai"
	cookieDomain string // cookie scope, e.g. ".folio.ai"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.folio.ai")
//   - COOKIE_DOMAIN           (e.g. ".folio.ai")
