...
var rootHelpTemplate = `Work seamlessly with Folio from the command line.

USAGE
  folio <command> <subcommand> [flags]
{{range .Groups}}
{{.Title}}
...
EXAMPLES
  ...
  $ folio daemon start
  $ folio agent list --output json

ENVIRONMENT VARIABLES
  FOLIO_SERVER_URL    Override the default server URL
  FOLIO_WORKSPACE_ID  Set the active workspace

LEARN MORE
  Use ` + "`folio <command> <subcommand> --help`" + ` for more information about a command.
`
