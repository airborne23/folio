...
var rootCmd = &cobra.Command{
	Use:   "folio",
	Short: "Folio CLI — local agent runtime and management tool",
	Long:  "Work seamlessly with Folio from the command line.",
	SilenceUsage:  true,
	SilenceErrors: true,
}
...
func init() {
	...
	rootCmd.SetVersionTemplate("folio {{.Version}}\n")
	...
	rootCmd.PersistentFlags().String("server-url", "", "Folio server URL (env: FOLIO_SERVER_URL)")
	rootCmd.PersistentFlags().String("workspace-id", "", "Workspace ID (env: FOLIO_WORKSPACE_ID)")
