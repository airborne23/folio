...
var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update folio to the latest version",
	RunE:  runUpdate,
}
...
func runUpdate(_ *cobra.Command, _ []string) error {
	...
	if cli.IsBrewInstall() {
		...
		if err != nil {
			...
			return fmt.Errorf("brew upgrade failed: %w\nYou can try manually: brew upgrade folio-ai/tap/folio", err)
		}
	...
	if latest == nil {
		return fmt.Errorf("could not determine latest version; check https://github.com/airborne23/folio/releases/latest")
	}
