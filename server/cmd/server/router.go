...
import (
	...
	obsmetrics "github.com/airborne23/folio/server/internal/metrics"
	...
	r.Group(func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			r.Route("/api/channels", func(r chi.Router) {
				...
				r.Get("/{channelID}/threads/{parentID}", h.GetChannelThread)
				r.Post("/{channelID}/messages/{messageID}/reactions", h.AddChannelReaction)
				r.Delete("/{channelID}/messages/{messageID}/reactions/{emoji}", h.RemoveChannelReaction)
			})
		})
	})
