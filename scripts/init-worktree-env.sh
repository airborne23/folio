...
postgres_db="folio_${slug}_${offset}"
postgres_port=5432
...
DATABASE_URL=postgres://folio:folio@localhost:${postgres_port}/${postgres_db}?sslmode=disable

PORT=${backend_port}
JWT_SECRET=change-me-in-production
FOLIO_DEV_VERIFICATION_CODE=888888
FOLIO_SERVER_URL=ws://localhost:${backend_port}/ws
