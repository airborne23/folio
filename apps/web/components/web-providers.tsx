...
import { createBrowserCookieLocaleAdapter } from "@folio/core/i18n/browser";
import type { LocaleResources, SupportedLocale } from "@folio/core/i18n";
...
// cookie mode on their next logout/login cycle (logout clears folio_token).
// Sunset: once telemetry shows <1% of sessions still carry folio_token,
...
function hasLegacyToken(): boolean {
  ...
  try {
    return Boolean(window.localStorage.getItem("folio_token"));
  } catch {
    return false;
  }
}
