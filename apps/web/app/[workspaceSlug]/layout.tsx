...
import { WorkspaceSlugProvider, paths } from "@folio/core/paths";
import { workspaceBySlugOptions } from "@folio/core/workspace";
import { setCurrentWorkspace } from "@folio/core/platform";
import { useAuthStore } from "@folio/core/auth";
import { NoAccessPage } from "@folio/views/workspace/no-access-page";
import { FolioIcon } from "@folio/ui/components/common/folio-icon";
import { useWorkspaceSeen } from "@folio/views/workspace/use-workspace-seen";
