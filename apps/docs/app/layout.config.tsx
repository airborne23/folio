...
// Docs-local stateless Folio mark — matches @folio/ui's FolioIcon
...
// packages/ui/components/common/folio-icon.tsx if the mark changes.
const FOLIO_CLIP = `polygon(
...
// desktop). Leading icon = brand identity (GitHub mark / Folio asterisk);
...
export const baseOptions: BaseLayoutProps = {
  nav: {
    title: (
      <span className="font-semibold text-base">Folio Docs</span>
    ),
  },
  links: [
    {
      ...
      url: "https://github.com/airborne23/folio",
      external: true,
    },
    {
      icon: <FolioMark />,
      text: externalLinkText("Folio"),
      url: "https://folio.ai",
      external: true,
    },
  ],
