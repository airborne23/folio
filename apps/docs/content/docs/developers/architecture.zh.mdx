---
title: Architecture
description: Technical architecture of the Folio platform.
---

## Overview

Folio is a Go backend + monorepo frontend (pnpm workspaces + Turborepo) with shared packages.
...
- **Entry points** (`cmd/`): `server` (HTTP API), `folio` (CLI + daemon), `migrate`
