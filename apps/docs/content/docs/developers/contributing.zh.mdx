---
title: Contributing
description: Local development workflow for contributors working on the Folio codebase.
---
...
| | Main | Worktree |
|---|---|---|
| Database | `folio` | `folio_my_feature_702` |
...
```bash
docker compose exec -T postgres psql -U folio -d postgres \
