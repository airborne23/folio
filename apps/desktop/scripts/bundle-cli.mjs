#!/usr/bin/env node
// Builds the `folio` CLI from server/cmd/folio and copies the binary
...
//
// ldflags mirror `make build` so `folio --version` reports a meaningful
// version / commit / date.
//
...
function binaryNameForPlatform(platform) {
  return platform === "win32" ? "folio.exe" : "folio";
}
