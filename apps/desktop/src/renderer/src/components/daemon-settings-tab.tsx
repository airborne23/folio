        ...
        <div className="py-4">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {cliInstalled === null
              ? "Checking…"
              : cliInstalled
                ? "Folio CLI is installed and available in PATH."
                : "Folio CLI not found. Install it to enable daemon management."}
          </p>
          {cliInstalled === false && (
            <Button
              variant="outline"
              ...
              onClick={() =>
                window.desktopAPI.openExternal(
                  "https://github.com/airborne23/folio#cli-installation",
                )
              }
            >
              Installation Guide
