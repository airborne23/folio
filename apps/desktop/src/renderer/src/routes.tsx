...
import { ChannelsListPage } from "./pages/channels-list-page";
import { ChannelDetailPage } from "./pages/channel-detail-page";
import { IssuesPage } from "@folio/views/issues/components";
import { ProjectsPage } from "@folio/views/projects/components";
import { AutopilotsPage } from "@folio/views/autopilots/components";
import { MyIssuesPage } from "@folio/views/my-issues";
import { SkillsPage } from "@folio/views/skills";
import { DesktopRuntimesPage } from "./components/desktop-runtimes-page";
import { AgentsPage } from "@folio/views/agents";
import { InboxPage } from "@folio/views/inbox";
import { SettingsPage } from "@folio/views/settings";
